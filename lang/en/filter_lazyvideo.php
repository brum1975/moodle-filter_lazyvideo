...
$string['filtername'] = 'Lazy Video loader plugin';
$string['width'] = 'Maximum Width (0 to not specify)';
$string['height'] = 'Height (0 to not specify)';
$string['buttoncolor'] = 'Colour of play button';
